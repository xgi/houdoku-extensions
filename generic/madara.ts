...
export class MadaraClient {
  ...
  parseChapters: ParseChaptersFunc = (
    sourceType: SeriesSourceType,
    data: any,
    domParser: DOMParser
  ): Chapter[] => {
  ...
  fetchPageRequesterData: FetchPageRequesterDataFunc = (
    sourceType: SeriesSourceType,
  ...
  parsePageRequesterData: ParsePageRequesterDataFunc = (
    data: any,
    chapterSourceId: string,
    domParser: DOMParser
  ): PageRequesterData => {
